...
import static org.reactome.restfulapi.ReflectionUtility.getJavaBeanProperties;
import static org.reactome.restfulapi.ReflectionUtility.getNamedMethod;
import static org.reactome.restfulapi.ReflectionUtility.lowerFirst;
...
//    private Map<Long, DatabaseObject> reactomeToCaBioMap;
    ...
    public DatabaseObject createObject(GKInstance instance) throws Exception {
        ...
        String clsName = "org.reactome.restfulapi.models." + instance.getSchemClass().getName();
